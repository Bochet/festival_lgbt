	...
	<!--footer container--><div id="footer-container">
		...
		<div id="footer-widget">
			...
			<div id="copyright"><?php _e( 'Copyright', 'Hero' ); ?> <?php echo date( 'Y' ); ?> <?php echo of_get_option('footer_cr'); ?> | <?php _e( 'Powered by', 'Hero' ); ?> <a href="http://www.wordpress.org">WordPress</a> | Hero theme by <a href="http://www.antthemes.com">antthemes</a></div>
